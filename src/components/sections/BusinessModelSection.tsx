...
export const BUSINESS_MODEL_ITEMS: readonly BusinessModelItem[] = [
  {
    ...
    description: "Configuração inicial da metodologia Human Mobility Assurance para cada nova mobilidade.",
  },
  {
    title: "Acompanhamento e Medição Contínua",
    description:
      "Medições, com um mínimo de 3, ao longo de um ciclo de 3 a 6 meses.",
  },
  {
    ...
    <div className={className} data-section="business-model">
      ...
      {isFull && (
        ...
        <p className="font-body text-[15px] md:text-[16px] font-[300] text-white/85 leading-[1.8]">
            ...
            modelo foi desenhado para mitigar esse risco com um investimento
