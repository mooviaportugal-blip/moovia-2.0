...
function buildPendingClientEmail(name: string) {
  ...
  return shell(`
    ...
    <tr><td style="padding:0 40px 32px;text-align:center;"><a href="https://moovia.global/checkout" style="display:inline-block;background:#ad8957;color:#06091a;font-size:14px;font-weight:700;padding:14px 28px;border-radius:8px;text-decoration:none;margin-bottom:12px;letter-spacing:0.03em;">Voltar ao checkout →</a><br/><a href="https://wa.me/351910388877" style="display:inline-block;font-size:13px;color:rgba(249,245,236,0.5);padding:8px;text-decoration:none;">Precisa de ajuda? Fale no WhatsApp</a></td></tr>
  `);
}
...
function buildRejectedClientEmail(name: string) {
  ...
  return shell(`
    ...
    <tr><td style="padding:24px 40px 32px;text-align:center;"><a href="https://moovia.global/checkout" style="display:inline-block;background:#ad8957;color:#06091a;font-size:14px;font-weight:700;padding:14px 28px;border-radius:8px;text-decoration:none;margin-bottom:12px;letter-spacing:0.03em;">Tentar novamente →</a><br/><a href="https://wa.me/351910388877" style="display:inline-block;font-size:13px;color:rgba(249,245,236,0.5);padding:8px;text-decoration:none;">Precisa de ajuda? Fale no WhatsApp</a></td></tr>
  `);
}
        ...
        try {
          ...
          if (accessToken && paymentId && body?.type === "payment") {
            ...
            if (r.ok) {
              ...
              const recipients = ["frederico@moovia.global", "contacto@mooviaglobal.com"];
