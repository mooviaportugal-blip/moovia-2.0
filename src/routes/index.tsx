...
export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      ...
      { property: "og:description", content: "A MOOVIA coordena sua mudança do Brasil para Portugal: visto, moradia, escola, fiscalidade e adaptação familiar. Avaliação Estratégica a partir de €250." },
      { property: "og:url", content: "https://mooviaportugal.com/" },
      { property: "og:type", content: "website" },
      { name: "twitter:title", content: "MOOVIA Portugal, Coordenação de Transição Internacional" },
      { name: "twitter:description", content: "Brasil → Portugal. Visto, moradia, escola, fiscalidade e adaptação familiar coordenados num só lugar." },
    ],
