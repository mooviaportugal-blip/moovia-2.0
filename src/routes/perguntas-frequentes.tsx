  ...
  head: () => ({
    meta: [
      { title: "Perguntas Frequentes | MOOVIA" },
      {
        name: "description",
        content:
          "Respostas às principais dúvidas sobre a MOOVIA, o Global Mobility Assessment e o Global Mobility Assurance.",
      },
...
const faqs: QA[] = [
  ...
  },
  {
    ...
    a: "Não. Cada cliente recebe uma proposta construída a partir do seu Global Mobility Assessment. Não existe Plano A, B ou C. Existe um mandato personalizado. Um alfaiate não tem prateleira. Nós também não.",
  },
  {
    q: "Quanto tempo leva o processo de transição?",
    a: "Depende do perfil. Um profissional com proposta de trabalho confirmada pode estar operacional em 30 a 90 dias. Uma família em transição patrimonial pode levar de 3 a 12 meses. O cronograma real é definido no Global Mobility Assessment.",
  },
  {
    q: "Quanto custa a transição completa com a MOOVIA?",
    a: "Não trabalhamos com tabela de preços nem pacotes fechados. Cada proposta, desde o Global Mobility Assessment até um mandato completo, é construída à medida da necessidade específica de cada cliente. O valor é sempre definido após entendermos a complexidade do que precisa de ser feito.",
  },
  {
      ...
      <section className="relative bg-[#06091a] pt-36 pb-16 md:pt-44 md:pb-20 px-6 lg:px-20 overflow-hidden">
        ...
        <div className="relative z-10 mx-auto max-w-[1100px]">
          ...
          <p className="font-body text-[16px] md:text-[18px] font-[300] text-w35 leading-[1.7] max-w-[720px]">
            Sobre a MOOVIA, o Global Mobility Assessment, o mandato completo e o Global Mobility Assurance para empresas.
          </p>
        </div>
      </section>
